                                                ...
                                                <div className='teacherid_img'>
                                                    {
                                                        item.slice(-4).toLowerCase() === '.mp4'
                                                            ?
                                                            <video autoPlay="autoplay" src={`https://api.nutanpublic.naavhub.com/event_photos/${item}`} title={item.Event_Photos}></video>
                                                            :
                                                            <img src={`https://api.nutanpublic.naavhub.com/event_photos/${item}`} alt={item.Event_Photos} />
                                                    }
                                                </div>
                                            </div>
                                        ))
